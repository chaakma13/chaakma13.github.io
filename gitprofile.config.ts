...
const CONFIG = {
  github: {
    username: 'chaakma13', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  seo: {
    title: 'Portfolio of Cassie Haakma',
    description: '',
    imageURL: '',
  },
  social: {
    ...
    skype: '',
    telegram: '',
    website: 'https://chaakma13.github.io/',
    phone: '',
    email: 'chaakma13@gmail.com',
  },
  resume: {
    fileUrl:
